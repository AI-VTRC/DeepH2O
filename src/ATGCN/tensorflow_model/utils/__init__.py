...
from utils.detection_vanilla_gans_calculation import calculate_md_vanilla_gans
from utils.detection_vanilla_gans_calculation import calculate_rmd_vanilla_gans
